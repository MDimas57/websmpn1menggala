        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="flex items-start space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-300">
                        Mendidik generasi masa depan dengan karakter kuat, akademik unggul, dan siap menghadapi
                        tantangan global.
                    </p>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="text-gray-300 transition-colors hover:text-white">Panduan
                            Pendaftaran</a></li>
                    <li><a href="#" class="text-gray-300 transition-colors hover:text-white">Peta Domisili</a>
                    </li>
                    <li><a href="#" class="text-gray-300 transition-colors hover:text-white">Syarat dan
                            Ketentuan</a></li>
                    <li><a href="#" class="text-gray-300 transition-colors hover:text-white">FAQ</a></li>
                    <li><a href="#" class="text-gray-300 transition-colors hover:text-white">Pengumuman Resmi</a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="space-y-2 text-sm leading-relaxed text-gray-300">
                    <p>
                        ...
                        <a href="tel:+6281234567890" class="text-gray-300 transition-colors hover:text-white">+62
                            812-3456-7890</a>
                    </p>
                    <p>
                        <span class="block font-semibold">Email:</span>
                        <a href="mailto:info@smpn1menggala.sch.id"
                            class="text-gray-300 transition-colors hover:text-white">info@smpn1menggala.sch.id</a>
                    </p>
                    <p>
            ...
            <div class="flex order-1 space-x-4 md:order-2">
                <a href="#" aria-label="Facebook" class="transition-colors hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        aria-hidden="true">
                        <path
                            d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.494v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24h-1.918c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.294h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z" />
                    </svg>
                </a>
