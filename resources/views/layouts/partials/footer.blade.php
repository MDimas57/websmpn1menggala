<footer class="py-10 text-white border-t-4 md:pt-16 md:pb-8 bg-gradient-to-br from-amber-900 to-amber-800 border-amber-500">
    <div class="container px-4 mx-auto max-w-7xl md:px-6">
        ...
        <div class="grid grid-cols-1 gap-8 md:gap-12 lg:grid-cols-4 lg:gap-8">
            ...
            <div class="flex flex-col items-center space-y-4 text-center md:items-start md:text-left">
                <div class="flex flex-col items-center gap-3 md:flex-row">
                    <img src="{{ asset('images/logo smp.png') }}" alt="Logo SMPN 1 Menggala"
                        class="object-contain w-20 h-20 p-1 bg-white rounded-full shadow-lg md:w-16 md:h-16">
                    <div>
                        <h2 class="text-lg font-bold leading-snug tracking-wider uppercase">
            ...
            {{-- KOLOM 2: DOKUMEN --}}
            <div class="text-left">
                <h3 class="w-full pb-2 mb-4 text-lg font-bold uppercase border-b text-amber-400 border-amber-700 md:w-max">
                    Dokumen & Informasi
                </h3>
                <ul class="space-y-3 text-sm">
                    <li>
                        <a href='/ppdb' class="flex items-center text-gray-300 transition-colors group hover:text-white">
                            <span class="mr-2 transition-transform text-amber-500 group-hover:translate-x-1">➤</span> Panduan Pendaftaran
                        </a>
                    </li>
                    <li>
                        <a href='/informasi' class="flex items-center text-gray-300 transition-colors group hover:text-white">
                            <span class="mr-2 transition-transform text-amber-500 group-hover:translate-x-1">➤</span> Pengumuman Resmi
                        </a>
                    </li>
                    <li>
                        <a href='/kontak' class="flex items-center text-gray-300 transition-colors group hover:text-white">
                            <span class="mr-2 transition-transform text-amber-500 group-hover:translate-x-1">➤</span> FAQ (Tanya Jawab)
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="text-left">
                ...
                <div class="space-y-4 text-sm text-gray-300">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="tel:+6281234567890" class="transition hover:text-amber-400">+62 812-3456-7890</a>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="mailto:info@smpn1menggala.sch.id" class="break-all transition hover:text-amber-400">info@smpn1menggala.sch.id</a>
                    </div>
                </div>
            </div>
            ...
            <div class="text-left">
                ...
                <div class="w-full h-48 overflow-hidden bg-gray-600 border shadow-lg md:h-40 rounded-xl border-amber-700/50">
                    <iframe
                ...
                <a href="https://maps.app.goo.gl/S3wXASASshmaa68P9" target="_blank" class="inline-flex items-center gap-1 mt-3 text-xs transition text-amber-400 hover:text-white group">
                    Buka di Google Maps
        ...
        <div class="flex flex-col-reverse items-center justify-between gap-6 md:flex-row">
            <p class="text-sm text-center text-gray-400 md:text-left">
                &copy; {{ date('Y') }} <span class="font-semibold text-white">SMP Negeri 1 Menggala</span>. <br class="md:hidden">All rights reserved.
            </p>
            ...
            <div class="flex space-x-4">
                ...
                {{-- YouTube --}}
                <a href="https://youtube.com/@smpnegeri1menggala230?si=ZHpNrJsTNeNHrpP7" class="p-2.5 bg-amber-900/50 rounded-full text-gray-300 transition-all duration-300 hover:bg-red-600 hover:text-white hover:-translate-y-1">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                </a>
                {{-- Instagram --}}
                <a href="https://www.instagram.com/smpn1menggala?igsh=MWNmODhoM3hvbWk2OQ==" class="p-2.5 bg-amber-900/50 rounded-full text-gray-300 transition-all duration-300 hover:bg-pink-600 hover:text-white hover:-translate-y-1">
